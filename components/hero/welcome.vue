        ...
        >
          <div class="max-w-lg mx-auto space-y-8">
            <p class="text-3xl font-bold sm:text-4xl">
              Welcome to <br />Teaching For Devs
            </p>

            <p class="text-sm">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio unde
              maiores natus placeat earum, atque necessitatibus sunt. Ducimus
              inventore qui unde, corporis itaque rerum illum tempore quod?
              Quae, quam quaerat.
            </p>
